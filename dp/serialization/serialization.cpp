...
nlohmann::json packet_to_json(dp::parser::PacketView& view, dp::validation::PacketValidator& validator) {
    ...
    if (view.l4_type == dp::parser::L4Type::TCP) protocol = "TCP";
    else if (view.l4_type == dp::parser::L4Type::UDP) protocol = "UDP";
    else if (view.l4_type == dp::parser::L4Type::ICMP) protocol = "ICMP";
    ...
    else if(validator.errors.size() == 1 && validator.errors[0] == dp::validation::ValidationError::NONE) {
        status = "OK";
    }
    else {    
        status = "ERROR";
    ...
    for(dp::validation::ValidationError err : validator.errors) {
